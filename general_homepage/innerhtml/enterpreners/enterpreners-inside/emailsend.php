...
if(isset($_SESSION['email']) && isset($_SESSION['password']) && ($_SESSION['acctype']=='entrep')){
   ...
   $sql = "select * from  entrepreneurs_enrole where service_accept = 'abc' && service = 'mailandmessageservices' ";
   ...
   if($num == 1){
    ...
    echo "<meta http-equiv='refresh' content='0; url=enrole/enrole_emailsend.php' />";
   }
}
else{
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-12">
                    <div class="hero-image aos-init aos-animate" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <img src="https://www.pinclipart.com/picdir/big/496-4968394_customers-drivers-business-owners-in-the-same-signal.png" class="img-fluid" alt="working girl">
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-12 col-sm-12 align-self-center mobile-bottom-fix">
                    ...
                    <div class="left-text">
                        <p>Everyone knows that owning a website is a must for every business otherwise you will not be taken seriously by your potential clients. Your website should instantly provide your visitors with the message you are delivering and
                            the information they are seeking instantly. Your website is an important part of your business, it’s your image. Make your visitor’s experience a memorable one with a beautiful custom website design that is not only easy on
                            the eyes but easy to navigate.</p>
                    </div>
                </div>
                <div class="col-lg-1"></div>
                <div class="col-lg-5 col-md-12 col-sm-12 align-self-center mobile-bottom-fix-big" data-scroll-reveal="enter right move 30px over 0.6s after 0.4s">
                    <img src="https://thumbs.gfycat.com/SplendidWarlikeBumblebee-size_restricted.gif" class="rounded img-fluid d-block mx-auto" alt="App">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 align-self-center mobile-top-fix">
                    <div class="contact-form">
                        <form id="contact" action="back_emailsend.php?service=mailandmessageservices" method="POST">
                            <div class="row">
                                <div class="col-lg-10 col-md-12 col-sm-12">
                                    <fieldset>
                                        <input name="comment" type="text" class="form-control" id="comment" placeholder="Add a reason to enrole this service" required="">
                                    </fieldset>
                                </div>
                                <br>
