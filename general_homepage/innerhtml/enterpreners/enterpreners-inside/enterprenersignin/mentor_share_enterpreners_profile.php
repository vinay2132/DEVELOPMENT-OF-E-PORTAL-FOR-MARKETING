    ...
    <div class="page">
        ...
        <div class="content">
            ...
            <a href="mentor_share_enterpreners_profile.php">
                <button type="button" class="btn btn-outline-info" disabled>Share with Enterpreners</button>
            </a> &emsp;
        ...
        <main>
            ...
            <form method="POST" action="mentor_share_enterpreners_profile_back.php">
                <div class="form-group">
                    <label for="exampleInputEmail1">Enterpreners Email address</label>
                    <?php
