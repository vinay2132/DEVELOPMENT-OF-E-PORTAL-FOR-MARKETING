...
<body>
    <div class="page">
        ...
        <div class="content">
            &emsp; &emsp;
            <a href="investor_share_enterpreners_profile.php">
                <button type="button" class="btn btn-outline-info" >Share with Enterpreners</button>
            </a> &emsp;
            <a href="investor_share_mentor_profile.php">
                <button type="button" class="btn btn-outline-info" disabled>Share with Mentors</button> &emsp;
            </a>
            <a href="investor_share_profile.php">
        ...
        <main>
            ...
            <form method="POST" action="investor_share_mentor_profile_back.php">
