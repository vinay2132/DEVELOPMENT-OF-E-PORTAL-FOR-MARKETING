...
<body>
    ...
    <header tabindex="0">
        <p>
        <a class="logo" style="font-size: 25px;" style="color:#8261ee;"><i class="fa fa-line-chart"></i> <strong>Digital Trend</strong></a>   &emsp; Mentors Dashboard
    </p>
    </header>
  ...
  <header>
    <!-- here’s the avatar -->
    <a target="_blank" href="mentor_share_profile.php">
      <img src="https://cdn.sharechat.com/17905584_1584717315686.gif" class="hoverZoomLink">
    </a>
  ...
  <div class="profile-bio">
    ...
    <p>
    Skill sets: <?php echo $skills; ?>
</br>
   Expertise : <?php  echo $expertise; ?></br>
   Experience as a Mentor :<?php echo $experience  ?></br>
    </p>
