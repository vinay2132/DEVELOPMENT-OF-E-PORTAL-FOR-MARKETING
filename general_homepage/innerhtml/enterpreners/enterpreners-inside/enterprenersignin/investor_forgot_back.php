...
$_SESSION['email']=$email;
  ...
  try{
    ...
    $mail->Body = "<h3>Name : $full_name <br>Email: $email <br>Message : $message</h3><a href='http://localhost/pp/college_majorproject/general_homepage/innerhtml/enterpreners/enterpreners-inside/enterprenersignin/investor_reset_password.html?email=$email'>register account</a>";
