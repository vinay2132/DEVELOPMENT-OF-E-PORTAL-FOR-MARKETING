...
<body>
    <div class="page">
        <header tabindex="0">  <p>
        <a class="logo" style="font-size: 25px;" style="color:#8261ee;"><i class="fa fa-line-chart"></i> <strong>Digital Trend</strong></a>   &emsp; Mentors Profile
    </p></header>
                            ...
                            <div class="card-block">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <h6 class="text-muted f-w-400"><?php echo $linkedinlink;   ?></h6>
                                    </div>
                                    </br>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <p class="m-b-10 f-w-600">Area of expertise</p>
                                        <h6 class="text-muted f-w-400"><?php echo $expertise;   ?></h6>
                                    </div>
                                    </br>
                                    <div class="col-sm-6">
                                        <p class="m-b-10 f-w-600">Experience as a Mentor</p>
