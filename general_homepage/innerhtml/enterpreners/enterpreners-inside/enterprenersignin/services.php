...
<body>
        ...
        <div id="nav-container">
            ...
            <div id="nav-content" tabindex="0">
                <ul>
                    ...
                    <li><a href = "enterprener_view_contact.php">View Contacts</a></li>
  ...
  <header>
    <!-- here’s the avatar -->
    <a target="_blank" href="enterprener_share_profile.html">
  ...
  <div class="profile-bio">
    ...
    <p>
     ...
     About the Founders :<?php echo $about_founder  ?></br>
    </p>
