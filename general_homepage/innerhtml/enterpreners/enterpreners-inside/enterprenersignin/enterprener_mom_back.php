...
if(isset($_SESSION['email']) && isset($_SESSION['password']) && ($_SESSION['acctype']=='entrep')){
   ...
   $Mentor_email = $_POST['Mentor_email'];
    ...
    #file name with a random number so that similar dont get replaced
     if( $file_name != "" ){
    $pname = rand(1000,10000)."-" ."$email" ."-".$_FILES["file"]["name"];
     }
...
$sql = "insert into mom(Mentor_email,Entrepreneur_Email,Email_use_investors,other_email,MOM_file,commentfile,date)values('$Mentor_email','$email','$other_email','$Email_use_investors','$pname','$commentfile','$current_date')";
  if(mysqli_query($conn,$sql)){
        ...
        $alert = '';
          ...
          try{
            ...
            $mail->addAddress('wobewo5338@whyflkj.com');
            $mail->addAddress($_POST['other_email']);
            $mail->addAddress($_POST['Mentor_email']); // Email address where you want to receive emails (you can use any of your gmail address including the gmail address which you used as SMTP server)
            ...
            <br><br><strong>Form submited by user</strong><a  href='membersinfo/mom/$pname'>&nbsp;&nbsp; $pname</a>
            <p>
              <h3>
                Team CTY.
              </h3>
