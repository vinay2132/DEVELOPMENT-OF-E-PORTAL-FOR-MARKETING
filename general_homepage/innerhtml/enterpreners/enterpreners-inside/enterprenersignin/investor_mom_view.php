...
if(isset($_SESSION['email']) && isset($_SESSION['password']) && ($_SESSION['acctype']=='investor')){
   ...
   //$email = $_GET['email'];
    ...
    $sql = "select * from mom where Email_use_investors = '".$Email."'";
...
<body>
    <div class="page">
        <header tabindex="0">  <p>
        <a class="logo" style="font-size: 25px;" style="color:#8261ee;"><i class="fa fa-line-chart"></i> <strong>Digital Trend</strong></a>   &emsp; Investor MOM files
    </p></header>
...
while($row = $result->fetch_assoc()) {
 ?>
        <tr>
            ...
            <td><?php echo$row['Entrepreneur_email']; ?></td>
