...
<body>
    <div class="page">
        <header tabindex="0">
            <p>
                <a class="logo" style="font-size: 25px;" style="color:#8261ee;"><i class="fa fa-line-chart"></i> <strong>Digital Trend</strong></a> &emsp; Enterpreners Dashboard
            </p>
        </header>
        ...
        <div class="content">
            &emsp; &emsp;
            <a href="enterprener_share_mentor_profile.php">
                <button type="button" class="btn btn-outline-info " disabled>Share with Mentors</button>
            </a> &emsp;
            <a href="enterprener_share_investor_profile.php">
                <button type="button" class="btn btn-outline-info">Share with Investors</button> &emsp;
            </a>
            <a href="enterprener_share_profile.html">
        ...
        <main>
            ...
            <form method="POST" action="entrprener_share_mentor_profile_back.php">
                <div class="form-group">
                    <label for="exampleInputEmail1">Mentors Email address</label>
                    <?php
                    //$mysqli = NEW MYSQLi('localhost','cmy_user','36p1c(KaHSoh','cmy');
                    
                    $resultSet = $db ->query("SELECT email FROM mentorship");
