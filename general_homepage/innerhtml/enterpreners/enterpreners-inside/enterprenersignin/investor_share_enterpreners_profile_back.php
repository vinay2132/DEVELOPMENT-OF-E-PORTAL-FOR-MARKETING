...
$alert = '';
  ...
  try{
    ...
    $mail->Body = "<h3>Name : $full_name <br>Email: $email <br>Message : $vkey</h3><a href='http://localhost/pp/college_majorproject/general_homepage/innerhtml/enterpreners/enterpreners-inside/enterprenersignin/investor_nonssecure_profile.php?email=$email' target='_blank'>register account</a>";
