...
<h4><center><u>Mentors Meeting details</u></center></h4>

<div class="contnr">
<div class="row">

<form method="POST" action="enterprener_mom_back.php" enctype="multipart/form-data">
...
<select name="Mentor_email" class="form-control">
<?php
...
//$resultSet = $db ->query("SELECT email FROM investors");
