...
$_SESSION['email']=$email;
  ...
  try{
    ...
    $mail->isHTML(true);
    $mail->Subject = 'Digital Trends (Forgot password)';
    //$mail -> Body = "<a href='http://localhost/pp/a1/varified.php?vkey=$vkey'>register account</a>";
    //<h3>Name : $full_name <br>Email: $email <br>Message : $message</h3><a href='http://localhost/pp/college_majorproject/general_homepage/innerhtml/enterpreners/enterpreners-inside/enterprenersignin/enterprener_reset_password.html?email=$email'>register account</a>"
    $mail->Body = "
                            ...
                            <table role='presentation' style='width:100%;border-collapse:collapse;border:0;border-spacing:0;'>
                                <tr>
                                    <td style='padding:0 0 36px 0;color:#153643;'>
                                        ...
                                        Hi <b>$full_name</b>; thanks for contacting us and the query you send was <b>$message</b> and we promise you that our team will definatelly get back to you</br>
                                        </p>
                                        <p style='margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;'>
                                        <a href='http://localhost/pp/college_majorproject/general_homepage/innerhtml/enterpreners/enterpreners-inside/enterprenersignin/enterprener_reset_password.html?email=$email'>
                                        <button class='button button1'><i>Click Hear to reset your password</i></button>
                                        </a>
                                        </p>
                                        <p style='margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;'>
