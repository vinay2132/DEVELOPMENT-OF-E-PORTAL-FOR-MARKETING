...
if(isset($_SESSION['email']) && isset($_SESSION['password']) && ($_SESSION['acctype']=='entrep')){
   ...
   // $email = $_GET['email'];
   $sql = "select * from  entrepreneurs_enrole where service_accept = 'abc'  && service = 'webappdevelopemnt'";
   ...
   if($num == 1){
    ...
    echo "<meta http-equiv='refresh' content='0; url=enrole/enrole_webappdevelop.php' />";
   }
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 align-self-center mobile-top-fix">
                    <div class="contact-form">
                        <form id="contact" action="back_webappdevelop.php?service=webappdevelopemnt" method="POST">
                            <div class="row">
