...
if(isset($_SESSION['email']) && isset($_SESSION['password']) && ($_SESSION['acctype']=='entrep')){
   ...
   $sql = "select * from  entrepreneurs_enrole where service_accept = 'abc' && service = 'blogsrequest' ";
   ...
   if($num == 1){
    ...
    echo "<meta http-equiv='refresh' content='0; url=enrole/enrole_blogsrequest.php' />";
   }
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-12">
                    <div class="hero-image aos-init aos-animate" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <img src="https://www.pinclipart.com/picdir/big/495-4952498_would-you-like-to-take-the-next-step.png" class="img-fluid" alt="working girl">
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 col-md-12 col-sm-12 align-self-center mobile-bottom-fix-big" data-scroll-reveal="enter right move 30px over 0.6s after 0.4s">
                    <img src="https://i.pinimg.com/originals/d3/46/4a/d3464a4351fdf340ccb6bb37c281381a.gif" class="rounded img-fluid d-block mx-auto" alt="App">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 align-self-center mobile-top-fix">
                    <div class="contact-form">
                        <form id="contact" action="back_blogentries.php?service=blogsrequest" method="POST">
                            <div class="row">
                                <div class="col-lg-10 col-md-12 col-sm-12">
                                    <fieldset>
                                        <input name="comment" type="text" class="form-control" id="comment" placeholder="Basic Info And Need of Blogs" required="">
                                    </fieldset>
                                </div>
                                <br>
