...
$reg="INSERT Into entrepreneurs_blogsrequest (email, company_name,  reference_url,additional_contant,file_required) values('$email','$company_name','$reference_url','$additional_contant','$pname1')";
     mysqli_query($db,$reg);
