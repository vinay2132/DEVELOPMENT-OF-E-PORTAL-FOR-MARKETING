        ...
        <div class="wrapper wrapper--w900">
            <div class="card card-6">
                <div class="card-heading">
                    <h2 class="title">Basic details for sending mails</h2>
                </div>
                <div class="card-body">
                    <form method="POST" action="back_enrole_emailsend.php" enctype="multipart/form-data">
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="name">Mail Header</div>
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-6" type="text" name="mail_header" placeholder="Mail header details">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="name">Mail body content</div>
                            <div class="value">
                                <div class="input-group">
                                    <textarea class="textarea--style-6" name="mail_content" placeholder="Mail body details"></textarea>
                                </div>
                            </div>
                        </div>
                      <!--  <div class="form-row">
