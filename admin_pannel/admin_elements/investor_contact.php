      ...
      <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Investor's Contacts</h4>
...
while($row = $result1->fetch_assoc()) {
  ...
  echo  "<td><a href=investor_contact_sent.php?email=".$row['email']." ><button type=\"button\" class=\"btn btn-info btn-icon-text\"><i class=\"mdi mdi-printer btn-icon-append\"></i> Sent</button></a></td>";
  


 
      echo  "<td><a href=investor_contact_received.php?email=".$row['email']." ><button type=\"button\" class=\"btn btn-primary btn-icon-text\"> <i class=\"mdi mdi-file-check btn-icon-append\"></i>Received</button></a></td>";
