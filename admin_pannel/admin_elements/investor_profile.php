      ...
      <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Investor's Profile</h4>
                  <p class="card-description">
                   <a target = "_blank" href ="../../general_homepage/innerhtml/enterpreners/enterpreners-inside/enterprenersignin/investorsignin.html"><code> We get Data Form</code></a>
                  </p>
...
while($row = $result1->fetch_assoc()) {
  ...
  echo "<td><div>".$row['stage']."</div></td>";
  echo  "<td><a href=investor_viewprofile.php?email=".$row['email']." ><button type=\"button\" class=\"btn btn-info btn-icon-text\"><i class=\"mdi mdi-printer btn-icon-append\"></i> View</button></a></td>";
