      ...
      <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Investor Requests Received</h4>
                  <p class="card-description">
                   <a target = "_blank" href ="../../general_homepage/innerhtml/enterpreners/enterpreners-inside/enterprenersignin/mentors_view_contact.php"><code> We get Data Form</code></a>
                  </p>
