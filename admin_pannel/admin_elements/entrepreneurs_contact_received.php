      ...
      <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Entrepreneur Requests Received</h4>
                  <p class="card-description">
                   <a target = "_blank" href ="../../general_homepage/innerhtml/enterpreners/enterpreners-inside/enterprenersignin/enterprener_view_contact.php"><code> We get Data Form</code></a>
                  </p>
...
while($row = $result1->fetch_assoc()) {
  ...
  echo "<td><div>".$row['acctype']."</div></td>";
  echo "<td><div>".$row['date']."</div></td>";
 // echo  "<td><a href=entrepreneurs_contact_sent.php?email=".$row['email']." ><button type=\"button\" class=\"btn btn-info btn-icon-text\"><i class=\"mdi mdi-printer btn-icon-append\"></i> Sent</button></a></td>";
   //   echo  "<td><a href=entrepreneurs_contact_sent.php?email=".$row['email']." ><button type=\"button\" class=\"btn btn-primary btn-icon-text\"> <i class=\"mdi mdi-file-check btn-icon-append\"></i>Received</button></a></td>";
     

         echo  "<td><a href=delete_entrepreneurs_contact_send.php?email=".$row['email']." ><button type=\"button\" class=\"btn btn-success btn-icon-text\"> <i class=\"mdi mdi-alert btn-icon-prepend\"></i>Delete</button></a></td>";
