      ...
      <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Investor Requests Sent</h4>
...
while($row = $result1->fetch_assoc()) {
  ...
  //echo  "<td><a href=mentor_contact_sent.php?email=".$row['email']." ><button type=\"button\" class=\"btn btn-info btn-icon-text\"><i class=\"mdi mdi-printer btn-icon-append\"></i> Sent</button></a></td>";
