                        ...
                        <li class="nav-item">
                            ...
                            <div class="submenu">
                                <ul>
                                    ...
                                    <li class="nav-item"><a class="nav-link" href="enterprens_form_sub.php">Mentorrship Forms</a></li>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description">
                   <a target = "_blank" href ="../../general_homepage/innerhtml/contactfrom/contact.html"><code> We get Data Form</code></a>
                  </p>
...
while($row = $result1->fetch_assoc()) {
  ...
  echo  "<td><a href=delete_contactus.php?id=".$row['id']." ><button type=\"button\" class=\"btn btn-success btn-icon-text\"> <i class=\"mdi mdi-alert btn-icon-prepend\"></i>Delete</button></a></td>";
