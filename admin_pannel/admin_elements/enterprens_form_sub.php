      ...
      <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Mentorship Form Sub</h4>
...
while($row = $result1->fetch_assoc()) {
  ...
  echo  "<td><a href=enterpreneur_view_doc.php?email=".$row['email']." ><button type=\"button\" class=\"btn btn-info btn-icon-text\"><i class=\"mdi mdi-printer btn-icon-append\"></i> View</button></a></td>";
  echo  "<td><button type=\"button\" class=\"btn btn-primary btn-icon-text\"> <i class=\"mdi mdi-file-check btn-icon-append\"></i>Share</button></a></td>";
