                    ...
                    <div class="row m-l-0 m-r-0">
                        <div class="col-sm-4 bg-c-lite-green user-profile">
                            <div class="card-block text-center text-white">
                                ...
                                <p><?php echo $company_name;   ?></p> <i class=" mdi mdi-square-edit-outline feather icon-edit m-t-10 f-16"></i>
                            </div>
                        </div>
                        <div class="col-sm-8">
                            <div class="card-block">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <p class="m-b-10 f-w-600">Need of Mentor Description</p>
                                        <h6 class="text-muted f-w-400"> 
                                           
                                            <a target="_blank" href="membersinfo/<?php echo  $row['mentor_describe']; ?>?edit=<?php echo  $row['mentor_describe']; ?>" class="edit_btn" ><?php echo  $row['mentor_describe']; ?></a>     
                                        </h6>
                                    </div>
                                    </br>
                                </div>
