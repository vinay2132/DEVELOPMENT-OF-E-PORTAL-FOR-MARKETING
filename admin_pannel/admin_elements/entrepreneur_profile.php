      ...
      <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Entrepreneur Profile</h4>
                  <p class="card-description">
                   <a target = "_blank" href ="../../general_homepage/innerhtml/enterpreners/enterpreners-inside/enterprenersignin/enterprenersignin.html"><code> We get Data Form</code></a>
                  </p>
...
while($row = $result1->fetch_assoc()) {
  ...
  $emailss = $row['email']; 
                    						   ...
                    						   $sql = "SELECT * FROM  entrepreneurs WHERE email = '$emailss' " ;
 
                                                 $res=mysqli_query($db,$sql);
                                                  $rowss = $res->fetch_assoc();
                            $mentorship=$rowss['mentorship'];


  if ($mentorship == 'ab'){
    echo  "<td><a href=mentorship_update_1.php?email=".$row['email']." ><button type=\"button\" class=\"btn btn-dark btn-icon-text\"><i class=\"mdi mdi-reload btn-icon-prepend\"></i>Click to Accept</button></a></td>";
    }
    elseif ($mentorship == 'abc'){
      echo  "<td><a href=mentorship_update_2.php?email=".$row['email']." ><button type=\"button\" class=\"btn btn-primary btn-icon-text\"> <i class=\"mdi mdi-file-check btn-icon-append\"></i>Accepted</button></a></td>";
       }
         else{
