      ...
      <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Mentors MOM Profile</h4>
                  <p class="card-description">
                   <a target = "_blank" href ="../../general_homepage/innerhtml/enterpreners/enterpreners-inside/enterprenersignin/mentors_mom.php"><code> We get Data Form</code></a>
...
while($row = $result1->fetch_assoc()) {
  echo "<tr>";
  echo "<td> " .$row['Entrepreneur_email']. "</td>";
  echo "<td><div>".$row['other_email']."</div></td>";
  echo "<td><div>".$row['Email_use_investors']."</div></td>";
  echo "<td> " .$row['MOM_file']. "</td>";
  echo "<td><div>".$row['commentfile']."</div></td>";
  echo "<td><div>".$row['date']."</div></td>";
  //echo  "<td><a href=mentors_viewprofile.php?email=".$row['email']." ><button type=\"button\" class=\"btn btn-info btn-icon-text\"><i class=\"mdi mdi-printer btn-icon-append\"></i> View</button></a></td>";
  
  //echo  "<td><a href=mentors_viewMOM.php?email=".$row['email']." ><button type=\"button\" class=\"btn btn-info btn-icon-text\"><i class=\"mdi mdi-printer btn-icon-append\"></i> MOM </button></a></td>";

  
         //echo  "<td><a href=delete_mentors.php?email=".$row['email']." ><button type=\"button\" class=\"btn btn-success btn-icon-text\"> <i class=\"mdi mdi-alert btn-icon-prepend\"></i>Delete</button></a></td>";
